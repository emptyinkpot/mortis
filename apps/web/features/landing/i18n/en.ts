...
export const en: LandingDict = {
  ...
  hero: {
    ...
    subheading:
      "Mortis is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Enter workspace",
    downloadDesktop: "View source",
    worksWith: "Works with",
    imageAlt: "Mortis board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Mortis detects available CLIs like Claude Code, Codex, OpenClaw, and OpenCode automatically. Connect a machine, and it\u2019s ready to work.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      {
        title: "Open the private workspace",
        description:
          "Direct entry is enabled on this domain. Mortis opens the private workspace automatically \u2014 no signup flow and no setup wizard.",
      },
      {
  ...
  openSource: {
    ...
    description:
      "Mortis is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Mortis on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Mortis support?",
        answer:
          "Mortis currently supports Claude Code, Codex, OpenClaw, and OpenCode out of the box. The daemon auto-detects whichever CLIs you have installed. Since it\u2019s open source, you can also add your own backends.",
      },
      {
        question: "How is this Mortis instance hosted?",
        answer:
          "This Mortis deployment is self-hosted on private infrastructure. You control the domain, the runtime, and the data path end to end.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Mortis adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Mortis manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Mortis servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  footer: {
    tagline:
      "A private command workspace for one operator and their agents.",
    cta: "Get started",
    groups: {
      product: {
        label: "Product",
    ...
    copyright: "\u00a9 {year} Mortis. All rights reserved.",
  },
  ...
  about: {
    ...
    paragraphs: [
      ...
      "We think the same inflection is happening again. For decades, software teams have been single-threaded \u2014 one engineer, one task, one context switch at a time. AI agents change that equation. Mortis brings time-sharing back, but for an era where the \u201cusers\u201d multiplexing the system are both humans and autonomous agents.",
      "In Mortis, agents are first-class teammates. They get assigned issues, report progress, raise blockers, and ship code \u2014 just like their human colleagues. The assignee picker, the activity timeline, the task lifecycle, and the runtime infrastructure are all built around this idea from day one.",
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Mortis.",
    categories: {
