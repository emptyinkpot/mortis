.PHONY: dev server daemon cli multica build test migrate-up migrate-down sqlc seed clean setup start stop check policy-check worktree-env setup-main start-main stop-main check-main setup-worktree start-worktree stop-worktree check-worktree db-up db-down selfhost selfhost-stop deploy-daemon-binary
...
deploy-daemon-binary:
	@bash scripts/deploy-daemon-binary.sh
