...
INSERT INTO autopilot (
    ...
    priority, status, execution_mode, issue_title_template, task_context,
    created_by_type, created_by_id
) VALUES (
    $1, sqlc.narg('project_id'), $2, sqlc.narg('description'), $3,
    $4, $5, $6, sqlc.narg('issue_title_template'), sqlc.narg('task_context'),
    $7, $8
) RETURNING *;
...
UPDATE autopilot SET
    ...
    task_context = sqlc.narg('task_context'),
    updated_at = now()
WHERE id = $1
RETURNING *;
...
INSERT INTO agent_task_queue (agent_id, runtime_id, issue_id, status, priority, autopilot_run_id, context)
