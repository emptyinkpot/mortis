...
INSERT INTO autopilot (
    ...
    $4, $5, $6, $11, $12,
    $7, $8
) RETURNING id, workspace_id, project_id, title, description, assignee_id, priority, status, execution_mode, issue_title_template, created_by_type, created_by_id, last_run_at, created_at, updated_at, task_context
`
...
SELECT id, workspace_id, project_id, title, description, assignee_id, priority, status, execution_mode, issue_title_template, created_by_type, created_by_id, last_run_at, created_at, updated_at, task_context FROM autopilot
WHERE id = $1
`
