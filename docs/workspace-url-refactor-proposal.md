---
title: Workspace URL Refactor Proposal
status: proposal
audience: maintainers and contributors
scope: workspace-url architecture proposal
---

# Workspace URL 化重构 — 项目汇报

> Scope note: this file is a dated architecture proposal and project report.
> It is not a current-state control-plane document.
> When its examples mention historical `Multica` URLs or localhost defaults,
> read them as proposal context, not current Mortis private deployment truth.
